...
public class OrderItemPanel extends JPanel {
    ...
    private JPanel createFormSection() {
        ...
        btnSelectProduct = createButton("Chọn SP", "/icon/search.png", PRIMARY);
        btnAdd      = createButton("Thêm", "/icon/plus.png", PRIMARY);
        btnSaveEdit = createButton("Lưu sửa", "/icon/save.png", PRIMARY_DARK);
    ...
    private JPanel createTableSection() {
        ...
        btnEdit   = createButton("Sửa", "/icon/edit.png", PRIMARY_DARK);
        ...
        table = new JTable(new DefaultTableModel(
                new Object[][]{},
                new String[]{"Sản phẩm", "SL", "Đơn giá", "Thành tiền"}
        ));

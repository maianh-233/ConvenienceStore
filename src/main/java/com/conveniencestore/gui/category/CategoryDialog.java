package com.conveniencestore.gui.category;
...
public class CategoryDialog extends JDialog {
    ...
    private final CategoryResponseDTO dto;
    ...
    private String getTitleByMode() {
        return switch (mode) {
            case MODE_ADD -> "Thêm danh mục";
            case MODE_EDIT -> "Sửa danh mục";
            default -> "Xem danh mục";
        };
    }

    private void bindDTO(CategoryResponseDTO dto) {

...
public class PanelCategory extends JPanel{
    ...
    // ================= HEADER =================
    private String titlePanel = "Quản lý loại hàng";
   ...
   public PanelCategory(JFrame parentFrame) {
